...
namespace OfficeWebUI.Ribbon
{
    ...
    [ToolboxData("<{0}:MediumItemDropDown runat=server></{0}:MediumItemDropDown>")]
    [ParseChildren(true, "Items")]
    public class MediumItemDropDown : ControlAncestor, INamingContainer, IOfficeWebUIWebControl
    {
        #region Private
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            _Panel.CssClass = "RibbonItems RibbonItems_MediumItem RibbonItemWithMenu";
